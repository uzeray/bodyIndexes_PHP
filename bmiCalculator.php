...
<!DOCTYPE html>
 <html language="en">
    <head>
        ...
        <title>Body Mass Index & BMI Calculator - FitPatients</title>
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="general">
                ...
                <h1 class="pageHead">Body Mass Index Calculator</h1>
                ...
                <div class="res">
                    <?php echo "BMI Result is :". " " . round($bmiRes, 2); ?>
                </div>
            </div>
