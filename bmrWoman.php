...
<!DOCTYPE html>
 <html language="en">
    <head>
        ...
        <title>TDEE Calculator - Basal Metabolic Rate - BMR Calculator - BMR for Woman - FitPatients</title>
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="general">
                ...
                <h1 class="pageHead">Basal Metabolic Rate for Female</h1>

                <div class="cal">
                    <form action="bmrWoman.php">
                        <input type="number" min="100" max="220" name="cm" id="cm" placeholder="Enter Your Lenght with cm">
                        <input type="number" name="kg" min="20" max="200" id="kg" placeholder="Enter Your Weight">
                ...
                <div class="res">
                    <?php echo femaleBmr($cm, $kg, $age)." "."/kcal"." "."Minimum Value Per Day"; ?>
                </div>
            </div>
